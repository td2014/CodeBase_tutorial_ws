...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /tmp_host_share/workspace_dev/tutorial_ws/src/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /tmp_host_share/workspace_dev/tutorial_ws/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /tmp_host_share/workspace_dev/tutorial_ws/install)
...
if(NOT "/tmp_host_share/workspace_dev/tutorial_ws/devel/include;/tmp_host_share/workspace_dev/tutorial_ws/src/velodyne/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/tmp_host_share/workspace_dev/tutorial_ws/devel/include;/tmp_host_share/workspace_dev/tutorial_ws/src/velodyne/velodyne_pointcloud/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tmp_host_share/workspace_dev/tutorial_ws/src/velodyne/velodyne_pointcloud/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
