...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /tmp_host_share/workspace_dev/tutorial_ws/src/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /tmp_host_share/workspace_dev/tutorial_ws/devel)
  ...
  set(velodyne_driver_INSTALL_PREFIX /tmp_host_share/workspace_dev/tutorial_ws/install)
...
if(NOT "/tmp_host_share/workspace_dev/tutorial_ws/devel/include;/tmp_host_share/workspace_dev/tutorial_ws/src/velodyne/velodyne_driver/include " STREQUAL " ")
  set(velodyne_driver_INCLUDE_DIRS "")
  set(_include_dirs "/tmp_host_share/workspace_dev/tutorial_ws/devel/include;/tmp_host_share/workspace_dev/tutorial_ws/src/velodyne/velodyne_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tmp_host_share/workspace_dev/tutorial_ws/src/velodyne/velodyne_driver/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
